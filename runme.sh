...
: ${MODULES:=at24,ath,ath3k,ath9k,ath9k_common,ath9k_hw,authenc,bluetooth,btbcm,btintel,btrtl,btusb,can_dev,cdns3,cdns3_ti,cfg80211,crct10dif_ce,ecc,ecdh_generic,fuse,hdc2010,icss_iep,icssg_prueth,ip_tables,ipv6,irq_pruss_intc,iwlmvm,iwlwifi,libarc4,m_can,m_can_platform,mac80211,opt3001,pci_endpoint_test,pru_rproc,pruss,qcserial,rfkill,rpmsg_char,rpmsg_client_sample,rtc_abx80x,rti_wdt,sa2ul,sha512_generic,ti_k3_m4_remoteproc,ti_k3_r5_remoteproc,udc_core,usb_storage,usb_wwan,usbcore,x_tables,usbserial,virtio_rpmsg_bus,xhci_hcd,xhci_plat_hcd}
